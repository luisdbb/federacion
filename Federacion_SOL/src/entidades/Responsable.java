...
public class Responsable implements Serializable, Comparable<Responsable>, operacionesCRUD<Responsable> {
	/**
	 * 
	 */
	...
	public static void importarResponsables() {
		...
		try {
			...
			while ((linea = buffer.readLine()) != null) {
				...
				java.time.LocalTime horaini = LocalTime.of(Integer.valueOf(horaAux[0]), Integer.valueOf(campos[1]));
				String horafinStr = campos[4];
				horaAux = horafinStr.split("\\:");
				java.time.LocalTime horafin = LocalTime.of(Integer.valueOf(horaAux[0]), Integer.valueOf(campos[1]));
